...
<li> [x] The left skewness of the data suggests that the students are less likely to rate the professors highly. </li>
</ol>
```{r score-dist}
# type your code for Question 3 here, and Knit
summary(evals$score)
sum(evals$score<3)
ggplot(data = evals, mapping = aes(score)) + geom_histogram()
ggplot(data = evals, mapping = aes(y=score)) + geom_boxplot()
```
...
p1 <- ggplot(aes(y=bty_avg), data=evals) + geom_boxplot()
p2 <- ggplot(aes(y=age), data=evals) + geom_boxplot()
...
m4 <- lm(score ~ bty_avg, data = evals)
...
<li> [x] 0.12 points higher than minority professors, all else held constant. </li> 
