...
```{r}
# p(m is good | win) = p(win | good) p(good) / p(win)
a <- 1/3 * 1/2
b <- a + (1/2*1/2)
a/b
```
...
* [x] Posterior - $P(M_1 \text{ is Good} ~|~ \text{Win on } M_1)$ <br/> Prior - $P(M_1 \text{ is Good})$ <br/> Likelihood - $P(\text{Win on } M_1 ~|~ M_1 \text{ is Good})$
...
bandit_posterior(data = data.frame(machine = 2, outcome = "W"))
...
* $P(M_1\text{ is good}~|~\text{data}) = 0.250$,<br/> $P(M_2\text{ is good}~|~\text{data}) = 0.750$
* $P(M_1\text{ is good}~|~\text{data}) = 0.429$,<br/> $P(M_2\text{ is good}~|~\text{data}) = 0.571$
* [x] $P(M_1\text{ is good}~|~\text{data}) = 0.571$,<br/> $P(M_2\text{ is good}~|~\text{data}) = 0.429$
* $P(M_1\text{ is good}~|~\text{data}) = 0.750$,<br/> $P(M_2\text{ is good}~|~\text{data}) = 0.250$
</div>
...
data = data.frame(machine = c(2L, 1L, 2L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 1L, 1L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L), outcome = c("W", "L", "L", "L", "W", "W", "W", "L", "W", "L", "W", "L", "L", "L", "L", "L", "L", "L", "L", "W", "L", "L", "L", "W", "L", "L", "W", "L", "W", "W", "L", "L", "W", "W", "W", "L", "L", "L", "L", "L", "L", "L", "W", "L", "W", "L", "L", "W", "W", "L", "W", "W", "L", "L", "W", "L", "L", "W", "L", "W", "L", "W", "W", "L"))
...
likelihood <- dbinom(3, size=50, prob=p)
...
bandit_posterior(data.frame(machine = c(1,1,1), outcome = c("W","W","W")), prior = c(m1_good = 0.5, m2_good = 0.5), win_probs = c(good = 1/2, bad = 1/2))
