...
us12 %>%
  summarize(atheism_rate=sum(atheism=="atheist")/n())
```
...
```{r us-atheism-ci}
i <- inference(y = response, data = us12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
i
```
...
print("Brasil % Atheists")
i <- inference(y = response, data = br12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")

print("Canada % Atheists")
i <- inference(y = response, data = ca12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
...
i <- inference(y = response, x = year, data = spain, statistic = "proportion", type = "ht", alternative="twosided", method = "theoretical", success = "atheist")
...
i <- inference(y = response, x = year, data = us, statistic = "proportion", type = "ht", alternative="twosided", method = "simulation", success = "atheist")
```
...
n = (qnorm(0.975)^2) * 0.5*0.5 / 0.01^2
n
```
